...
* Im ersten Bereich (rotes Kästchen 1) kann die automatische Registrierung eingestellt werden.
  ...
  * **„Maximale Anzahl Teilnehmer“** gibt an ab wie vielen Teilnehmer:innen für den gesamten Bewerb eine Registrierung nichtmehr möglich ist. Eine maximale Teilnehmer:innen-Zahl pro Bewerbsklasse kann im Reiter "Bewerbsklassen" eingegeben werden.
  * Mit dem ON/OFF-Button **"Medizinische Zertifikate"** wird eingestellt ob beim Anmeldungsmail an die Athlet:innen an das medizinische Zertifikat erinnert werden sollen
