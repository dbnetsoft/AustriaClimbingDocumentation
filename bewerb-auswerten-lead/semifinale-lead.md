...
{% content-ref url="../verfugbare-bewerbsmodi/lead/" %}
[lead](../verfugbare-bewerbsmodi/lead/)
{% endcontent-ref %}
...
* In der Tabelle werden alle registrierten Athlet\*innen angezeigt, aber nur fürs Semifinale qualifizierte Athlet\*innen haben eine Startposition&#x20;
  * Siehe Beispiel Abbildung auf Page Boulder Semifinale - sieht bei einem Lead Bewerb genauso aus.
* Startlisten, Schiedsrichterlisten,… wie in der Page "Startliste" beschrieben öffnen
...
{% content-ref url="qualifikation-lead/schiedsrichteroberflache-live-scoring-lead.md" %}
[schiedsrichteroberflache-live-scoring-lead.md](qualifikation-lead/schiedsrichteroberflache-live-scoring-lead.md)
{% endcontent-ref %}
