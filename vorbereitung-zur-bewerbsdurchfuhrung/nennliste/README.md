...
<figure><img src="../../.gitbook/assets/Nennungen_all.jpg" alt=""><figcaption><p>Auswerteroberfläche Register Nennungen</p></figcaption></figure>
...
* **Öffentliche Meldeliste:** zum Veröffentlichen; beinhaltet nur Daten, die veröffentlicht werden können
* **Interne Meldeliste**: für die Registrierung; beinhaltet zusätzlich Informationen, z.B. ob ein gültiges medizinisches Zertifikat hinterlegt ist, ob die nötigen Dokumente abgehakt wurden bei der Anmeldung (siehe Bewerbe anlegen - Dokumente)
...
{% content-ref url="../atlet-innen-hinzufugen-entfernen.md" %}
