# Finale & Gesamtwertung (Boulder\&Lead)

Findet ein Finale statt, muss das im Register „Bewerbsklassen“ der Auswertungsoberfläche für beide Disziplinen (Boulder und Lead) eingestellt werden. Die zusätzlichen zu treffenden Einstellungen (Quote, Modus, Routenanzahl,…) für diese Runde sind auf folgender Page erklärt:

{% content-ref url="../vorbereitung-zur-bewerbsdurchfuhrung/bewerbsklassen-einstellungen/boulder-and-lead.md" %}
...
* Sobald der Status einer Bewerbsklasse auf „Offizielles Ergebnis“ ist, können die Wertungen nicht mehr geändert werden (die Tabelle im Register Auswertung ist grau hinterlegt für die jeweilige Bewerbsklasse). Um doch noch Änderungen vorzunehmen, muss der Status wieder geändert werden.
...
* Startreihenfolge über den Button auslosen. Es gibt zwei Möglichkeiten:
  * Zufällig
  * Nach vorheriger Boulder\&Lead Runde: der / die am schlechtesten platzierte für das Finale qualifizierte Athlet\*in in der kombinierten Wertung (Boulder\&Lead) startet zuerst, der / die Bestplatzierte zum Schluss
...
#### Sobald eine Einzeldisziplin des Finales startet den Status der entsprechenden Bewerbsklasse und Disziplin auf „Läuft“ stellen
...
{% content-ref url="qualifikation-boulder-and-lead/ergebniserstellung-register-ergebnisse-boulder-and-lead.md" %}
[ergebniserstellung-register-ergebnisse-boulder-and-lead.md](qualifikation-boulder-and-lead/ergebniserstellung-register-ergebnisse-boulder-and-lead.md)
{% endcontent-ref %}

#### Gefilterte Ergebnisse wie zum Beispiel Bundeslandreihungen können im Register „Wertungen“ erstellt werden.

{% content-ref url="../bewerb-auswerten-boulder/finale-and-gesamtergebnis-boulder/wertungen.md" %}
