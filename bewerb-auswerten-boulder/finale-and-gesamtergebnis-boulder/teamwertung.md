...
WICHTIG: Um eine Teamwertung anlegen zu können, muss in der Admin Bewerbsoberfläche unter "Bearbeiten" der Haken "Team" aktiviert sein.

Im Register „Teamwertungen“ der Auswerteroberfläche können die Athlet\*innen in Teams zusammengefasst werden und ein Ranking der Teams erstellt werden.  Somit wird unter anderem ermöglicht die beste Sektion / das beste Bundesland schnell zu ermitteln. Das entsprechende Ergebnis PDF kann entweder direkt im Register „Teamwertungen" (wird im Folgenden erklärt) geöffnet werden.



<figure><img src="../../.gitbook/assets/teamwertung.jpg" alt=""><figcaption><p>Auswertungsoberfläche Register "Wertungen" neue Wertung hinzufügen</p></figcaption></figure>
...
* In der Spalte **„Team durch“** auswählen durch was die Teams zusammengesetzt werden. Die Möglichkeiten sind: Verein, Bundesland, Land, Gender, Team
  * bei der Auswahl des Filters "Team" wird auf individuell vergebene Teamnamen zurückgegriffen --> dazu muss in der Nennliste bei jedem Athleten / jeder Athletin ein Teamname hinterlegt werden  (siehe Screenshot unten). Achtet hier auf die richtige Schreibweise, da sonst die Teams nicht erkannt werden können.
...
**Eintragen von Teamnamen**

Wie oben beschrieben, können individuelle Teamnamen vergeben werden, um Athlet:innen beliebig zu gruppieren und Wertungen für das Team zu erstellen. Das ist bei den Nennungen möglich. Die Teamnamen können einfach hinten in der Tabelle eingegeben werden.
...
<figure><img src="../../.gitbook/assets/Bildschirmfoto 2025-09-20 um 09.58.11.png" alt=""><figcaption></figcaption></figure>

### Einstellungen gefilterte Wertungen

Nach Klick auf den Pfeil öffnet sich die im folgenden abgebildete Seite.

<figure><img src="../../.gitbook/assets/einstellungen.jpg" alt=""><figcaption><p>Einstellungen des Registers "Wertungen" der Auswertungsoberfläche </p></figcaption></figure>
...
Mit Klick auf "Update" werden die Athlet\*inne in die Teams aufgeteilt, die Punkte vergeben und das Ergebnis in der untenstehenden Tabelle und im PDF dargestellt.
